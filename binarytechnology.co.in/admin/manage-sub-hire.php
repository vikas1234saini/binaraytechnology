<?php
	$flag = 0; 	
	$data = $adminFunction->subHireList($paging,"frmmanagesubcategory");
...
<form method="post" name="frmmanagesubcategory" id="frmmanagesubcategory" action="" >
          ...
          <tr>
            ...
            <td align="center">
				<?php 
					...
					$category = $adminFunction->getHireDetails($id);
 ...
 <?php }?>
         ...
         <tr>
		 	<td colspan="8" align="right"><a href="index.php?act=addsubhire&limitstart=<?php echo $data['lstart'];?>" alt="Add Sub Category" ><img src="images/add.gif" border="0" /></a> <?php if($categoryList[0]['categoryId']!='') {?><input name="deletesubhire" value="Delete Sub Category" src="images/delete-button.gif" alt="" type="image"  border="0" onClick="return CheckAll1(this.form,'subcategory');"/></a><?php } ?></td>
          </tr>
