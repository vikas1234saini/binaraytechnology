<?php
	...
	$data = $adminFunction->ServicesList($paging,"frmmanagecategory");
	if(!isset($attributes['order'])){
		...
		$data = $adminFunction->ServicesList($paging,"frmmanagecategory","categoryName ".$order);
...
<form method="post" name="frmmanagecategory" id="frmmanagecategory" action="">
	<table width="95%" border="0" cellpadding="0" cellspacing="1" id="inner1">
	  ...
	  ?>
          <tr>
            ...
            <td align="center"><a href="#" onclick="return getFormValue('editservices','<?php echo $categoryList[$i]['categoryId']; ?>','<?php echo $data['lstart']; ?>');" title="Edit"><img src="images/edit.gif" border="0" alt="Edit" /></a></td>
 ...
 <?php }?>
         ...
         <tr>
		 	<td colspan="7" align="right"><a href="index.php?act=addservices&limitstart=<?php 
																		echo $data['lstart'];
																		if(isset($attributes['order'])){
