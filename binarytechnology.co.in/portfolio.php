...
<div class="wrapper" id="contentWrapper" style="overflow:hidden; padding: 20px 0;">
	<div class="boundingBox" id="content">
    	<ul id="portfolio-filter">
			...
			<li><a href="#mobile" title="" rel="university">Mobile Site</a></li>
        ...
        <ul id="portfolio-list" style="padding-left:40px;">
            ...
            <!--<li style="display: block;" class="programming design">
				<a href="http://lenovoexperiencia.com/" title="" target="_blank"><img src="<?php echo $config['siteurl']; ?>images/portfolio/Lenovo.jpg" alt=""></a>
				<p>
					Lenovo Experiencia
				</p>
			</li>-->
            <!--<li style="display: block;" class="programming design">
				<a href="http://info4city.com/sweepstake/" title="" target="_blank"><img src="<?php echo $config['siteurl']; ?>images/portfolio/sweepstack.png" alt=""></a>
				<p>
					Win Online Prizes
				</p>
			</li>-->
            ...
            <!--<li style="display: block;" class="design wordpress">
				<a href="http://info4city.com/test/" title="" target="_blank"><img src="<?php echo $config['siteurl']; ?>images/portfolio/dpress.png" alt=""></a>
				<p>
            ...
            <li style="display: block;" class="design wordpress">
				<a href="http://info4city.com/ace/" title="" target="_blank"><img src="<?php echo $config['siteurl']; ?>images/portfolio/ace.png" alt=""></a>
				<p>
					ACE Design Studio
				</p>
			</li>
            ...
            <li style="display: block;" class="programming design
">
				<a href="http://conectait.com.mx/login.php
" title="" target="_blank"><img src="<?php echo $config['siteurl']; ?>images/portfolio/mxlogin.jpg" alt=""></a>
				<p>
				Tech Blog
              ...
              <li style="display: block;" class="programming design">
				<a href="http://flowepic.com/mvp/" title="" target="_blank"><img src="<?php echo $config['siteurl']; ?>images/portfolio/flowepic.jpg" alt=""></a>
				<p>
			Flow Epic
             ...
             <li style="display: block;" class="programming design">
				<a href="http://dejateescuchar.com/home/" title="" target="_blank"><img src="<?php echo $config['siteurl']; ?>images/portfolio/dejateescuchar.jpg" alt=""></a>
				<p>
	Voting System
</p>
			</li>
              <li style="display: block;" class="programming design">
				<a href="http://novacircle.com/beta/" title="" target="_blank"><img src="<?php echo $config['siteurl']; ?>images/portfolio/novacircle.jpg" alt=""></a>
				<p>
	Community Base Site

</p>
			</li>  <li style="display: block;" class="programming design">
				<a href="http://vinuette.info/kayako/" title="" target="_blank"><img src="<?php echo $config['siteurl']; ?>images/portfolio/vinuette.jpg" alt=""></a>
				<p>
Chating Support System

</p>
			</li> 
             <li style="display: block;" class="programming design wordpress
">
				<a href="http://combiboilerquotes.org.uk/" title="" target="_blank"><img src="<?php echo $config['siteurl']; ?>images/portfolio/combiboilerquotes.jpg" alt=""></a>
				<p>
	Boiler Quotes
             ...
             <li style="display: block;" class="programming design">
				<a href="http://info4city.com/newsletter/admin" title="" target="_blank"><img src="<?php echo $config['siteurl']; ?>images/portfolio/admin.jpg" alt=""></a>
				<p>
Newsletter
             ...
             <li style="display: block;" class="programming design">
				<a href="http://atechindia.com/" title="" target="_blank"><img src="<?php echo $config['siteurl']; ?>images/portfolio/atechindia.jpg" alt=""></a>
				<p>
Advance Technology
             ...
             <li style="display: block;" class="programming design">
				<a href="http://atechlabs.net/" title="" target="_blank"><img src="<?php echo $config['siteurl']; ?>images/portfolio/atechlabs.png" alt=""></a>
				<p>
Atech Labs
            ...
            <li style="display: block;" class="programming design mobile
">
				<a href="http://info4city.com/diet/" title="" target="_blank"><img src="<?php echo $config['siteurl']; ?>images/portfolio/diet.jpg" alt=""></a>
				<p>
Diet Mobile App
            ...
            <li style="display: block;" class="programming">
				<a href="http://thecreditrepairshop.com/" title="" target="_blank"><img src="<?php echo $config['siteurl']; ?>images/portfolio/thecreditrepairshop.jpg" alt=""></a>
				<p>
The Credit Repair Shop
             ...
             <li style="display: block;" class="programming">
				<a href="http://therealdebtsolution.com/" title="" target="_blank"><img src="<?php echo $config['siteurl']; ?>images/portfolio/therealdebtsolution.jpg" alt=""></a>
				<p>
The real debt Solution
			...
			<li style="display: block;" class="programming design">
				<a href="http://info4city.com/super-fruit-health/" title="" target="_blank"><img src="<?php echo $config['siteurl']; ?>images/portfolio/sfh.png" alt=""></a>
				<p>
					Super Fruit Health
				</p>
			</li>
